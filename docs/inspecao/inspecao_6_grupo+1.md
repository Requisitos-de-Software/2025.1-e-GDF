...
<div 
  style="
    ...
    background: conic-gradient(
      #4caf50 92.86%,   /* Conforme */
      #ffeb3b 100%,     /* Incompleto (100% cumulativo) */
      #f44336 0%,       /* Não Conforme */
      #9e9e9e 0%        /* Não se Aplica */
    );
  "
  title='✅ 13 "Conforme", ⚠️ 1 "Incompleto"'
></div>

<div style="display: flex; justify-content: center; gap: 20px; margin-top: 20px; font-family: sans-serif;">
  <div style="display: flex; align-items: center; gap: 5px;">
    <div style="width: 15px; height: 15px; background: #4caf50; border-radius: 3px;"></div>
    <span>Conforme (13)</span>
  </div>
  <div style="display: flex; align-items: center; gap: 5px;">
    <div style="width: 15px; height: 15px; background: #f44336; border-radius: 3px;"></div>
    <span>Não Conforme (0)</span>
  ...
  <div style="display: flex; align-items: center; gap: 5px;">
    <div style="width: 15px; height: 15px; background: #ffeb3b; border-radius: 3px;"></div>
    <span>Incompleto (1)</span>
  </div>
  <div style="display: flex; align-items: center; gap: 5px;">
    <div style="width: 15px; height: 15px; background: #9e9e9e; border-radius: 3px;"></div>
    <span>Não se Aplica (0)</span>
...
| 1.2    | Adicionando evidencias 11, 12, 13 e 14         | [Gabriel Lopes](https://github.com/BrzGab)                                                                                                        | 23/06/2025 | [Artur Mendonça](https://github.com/ArtyMend07)                          | 23/06/2025      |
| 1.3    | Adicionando evidência 7 na inspeção      | [Lucas Mendonça](https://github.com/lucasarruda9)                                                                                                   | 23/06/2025 |            [Gabriel Lopes](https://github.com/BrzGab)               | 23/06/2025      |
| 1.3    | Adicionando evidências 8, 9 e 10 na inspeção      | [Artur Mendonça](https://github.com/ArtyMend07)                                                                                                   | 23/06/2025 |            [Lucas Mendonça](https://github.com/lucasarruda9)               | 23/06/2025      |
